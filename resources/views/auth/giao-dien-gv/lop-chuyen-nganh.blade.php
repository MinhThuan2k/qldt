...
<head>
    ...
    <title> Danh sách lớp chuyên ngành </title>
...
<div class="content-wrapper">
    ...
    <div class="content-wrapper" style="min-height: 251px;">
        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
                <li><a href="{{action('App\Http\Controllers\GiaoDienGiangVienController@giaoDienGiangVien', $id_giang_vien)}}"><i
                            class="fa fa-dashboard"></i>Trang chủ</a></li>
                <li class="active">Lớp chuyên ngành</li>
            </ol>
            <h1>Danh sách lớp chuyên ngành</h1>
            </section>
                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($gv as $item)
                                        <tr>
                                            <td>
                                                <a class="text-bold"
                                                   href="{{ action('App\Http\Controllers\GiaoDienGiangVienController@getSV',['id_lop_hoc'=>$item->id_lop_hoc]) }}">
                                                    {{ $item->ma_lop_hoc }}
                                                </a>
                                            </td>
                                            <td>{{$item->ten_lop_hoc}}</td>
                                            <td hidden>{{$item->nien_khoa}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
