                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                @foreach($ds as $item)
                                    <tr>
                                        <td>
                                            @if($item->khoa_chuyen_mon == 1)
                                                <a class="text-bold"
                                                   href="{{ action('App\Http\Controllers\DonViController@getDonViCT', $item->id_don_vi) }}">
                                                    {{ $item->ma_don_vi }} - {{ $item->ten_don_vi }}
                                                </a>
                                            @else
                                                <a class="text-bold"
                                                   href="#">
                                        ...
                                        <td>
                                            @if($item->khoa_chuyen_mon == 1)
                                                <span class="label label-primary">Khoa chuyên môn</span>
                                            @else
                                                <span class="label label-primary">Phòng ban</span>
                                            @endif
                                        </td>
                                        <td>{{ $item->vi_tri }}</td>
