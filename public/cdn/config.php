...
$wwwroot='';
$connection = 'sqlite: uploads/storage/cache.s3db';
$storage_path = 'uploads/data/storage';

// General
$moxieManagerConfig['general.license'] = 'EPHX-PROD-GLOH-HW89-1OMQ-YT9W-VD4F-RC8X';
...
$moxieManagerConfig['filesystem.exclude_directory_pattern'] = '/^thumbnail/i';
...
$moxieManagerConfig['edit.extensions'] = 'sgv,jpg,jpeg,png,gif,html,htm,txt';
...
$moxieManagerConfig['view.extensions'] = 'svg,jpg,jpeg,png,gif,html,htm,txt,pdf';
...
$moxieManagerConfig['thumbnail.height'] = 300;
$moxieManagerConfig['thumbnail.mode'] = "resize";
$moxieManagerConfig['thumbnail.folder'] = 'thumbnail';
...
// Local filesystem
$moxieManagerConfig['filesystem.local.wwwroot'] = $wwwroot;
$moxieManagerConfig['filesystem.local.urlprefix'] = $domain;
...
// Cache
$moxieManagerConfig['cache.connection'] = $connection;

// Storage
$moxieManagerConfig['storage.engine'] = 'json';
$moxieManagerConfig['storage.path'] = $storage_path;
...
$moxieManagerConfig['basicauthenticator.users'] = array(
    array("username" => "ContentOmg", "password" => "ContentOmg", "groups" => array("administrator"))
);
